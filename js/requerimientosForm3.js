document.addEventListener('DOMContentLoaded', function () {
    ...
    function initializeForm(formulario) {
        const tipoPieza = formulario.querySelector('[name="tipo-pieza-3"]');
        const tipoPiezaC1 = formulario.querySelector('[name="tipo-pieza-c1-3"]');
        const tipoPiezaC2 = formulario.querySelector('[name="tipo-pieza-c2-3"]');
        const tipoPiezaC3 = formulario.querySelector('[name="tipo-pieza-c3-3"]');
        const tipoPiezaC4 = formulario.querySelector('[name="tipo-pieza-c4-3"]');
        const tipoPiezaC5 = formulario.querySelector('[name="tipo-pieza-c5-3"]');
        const tipoPiezaC6 = formulario.querySelector('[name="tipo-pieza-c6-3"]');
        const tipoPiezaC7 = formulario.querySelector('[name="tipo-pieza-c7-3"]');
        const tipoPiezaC8 = formulario.querySelector('[name="tipo-pieza-c8-3"]');
        const tipoPiezaC9 = formulario.querySelector('[name="tipo-pieza-c9-3"]');
        const otraCategoria = formulario.querySelector('[name="otra-categoria-3"]');
        const otroTipoPieza = formulario.querySelector('[name="otra-pieza-3"]');
        const cargarAqui = formulario.querySelector('[name="cargar-recursos-3"][value="Cargar en form"]');
        const cargarWetransfer = formulario.querySelector('[name="cargar-recursos-3"][value="Cargar en WeTransfer"]');
        const recursosAqui = formulario.querySelector('#recursos-aqui-3');
        const recursosWetransfer = formulario.querySelector('#recursos-wetransfer-3');
        const piezaIncluidaSi = formulario.querySelector('[name="pieza-incluida-3"][value="Si"]');
        const piezaIncluidaNo = formulario.querySelector('[name="pieza-incluida-3"][value="No"]');
        const archivoDiv = formulario.querySelector('#archivo-div-3');
