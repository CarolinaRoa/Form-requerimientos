document.addEventListener('DOMContentLoaded', function () {
    ...
    function initializeForm(formulario) {
        const tipoPieza = formulario.querySelector('[name="tipo-pieza-2"]');
        const tipoPiezaC1 = formulario.querySelector('[name="tipo-pieza-c1-2"]');
        const tipoPiezaC2 = formulario.querySelector('[name="tipo-pieza-c2-2"]');
        const tipoPiezaC3 = formulario.querySelector('[name="tipo-pieza-c3-2"]');
        const tipoPiezaC4 = formulario.querySelector('[name="tipo-pieza-c4-2"]');
        const tipoPiezaC5 = formulario.querySelector('[name="tipo-pieza-c5-2"]');
        const tipoPiezaC6 = formulario.querySelector('[name="tipo-pieza-c6-2"]');
        const tipoPiezaC7 = formulario.querySelector('[name="tipo-pieza-c7-2"]');
        const tipoPiezaC8 = formulario.querySelector('[name="tipo-pieza-c8-2"]');
        const tipoPiezaC9 = formulario.querySelector('[name="tipo-pieza-c9-2"]');
        const otraCategoria = formulario.querySelector('[name="otra-categoria-2"]');
        const otroTipoPieza = formulario.querySelector('[name="otra-pieza-2"]');
        const cargarAqui = formulario.querySelector('[name="cargar-recursos-2"][value="Cargar en form"]');
        const cargarWetransfer = formulario.querySelector('[name="cargar-recursos-2"][value="Cargar en WeTransfer"]');
        const recursosAqui = formulario.querySelector('#recursos-aqui-2');
        const recursosWetransfer = formulario.querySelector('#recursos-wetransfer-2');
        const piezaIncluidaSi = formulario.querySelector('[name="pieza-incluida-2"][value="Si"]');
        const piezaIncluidaNo = formulario.querySelector('[name="pieza-incluida-2"][value="No"]');
        const archivoDiv = formulario.querySelector('#archivo-div-2');
