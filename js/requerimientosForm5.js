document.addEventListener('DOMContentLoaded', function () {
    ...
    function initializeForm(formulario) {
        const tipoPieza = formulario.querySelector('[name="tipo-pieza-5"]');
        const tipoPiezaC1 = formulario.querySelector('[name="tipo-pieza-c1-5"]');
        const tipoPiezaC2 = formulario.querySelector('[name="tipo-pieza-c2-5"]');
        const tipoPiezaC3 = formulario.querySelector('[name="tipo-pieza-c3-5"]');
        const tipoPiezaC4 = formulario.querySelector('[name="tipo-pieza-c4-5"]');
        const tipoPiezaC5 = formulario.querySelector('[name="tipo-pieza-c5-5"]');
        const tipoPiezaC6 = formulario.querySelector('[name="tipo-pieza-c6-5"]');
        const tipoPiezaC7 = formulario.querySelector('[name="tipo-pieza-c7-5"]');
        const tipoPiezaC8 = formulario.querySelector('[name="tipo-pieza-c8-5"]');
        const tipoPiezaC9 = formulario.querySelector('[name="tipo-pieza-c9-5"]');
        const otraCategoria = formulario.querySelector('[name="otra-categoria-5"]');
        const otroTipoPieza = formulario.querySelector('[name="otra-pieza-5"]');
        const cargarAqui = formulario.querySelector('[name="cargar-recursos-5"][value="Cargar en form"]');
        const cargarWetransfer = formulario.querySelector('[name="cargar-recursos-5"][value="Cargar en WeTransfer"]');
        const recursosAqui = formulario.querySelector('#recursos-aqui-5');
        const recursosWetransfer = formulario.querySelector('#recursos-wetransfer-5');
        const piezaIncluidaSi = formulario.querySelector('[name="pieza-incluida-5"][value="Si"]');
        const piezaIncluidaNo = formulario.querySelector('[name="pieza-incluida-5"][value="No"]');
        const archivoDiv = formulario.querySelector('#archivo-div-5');
